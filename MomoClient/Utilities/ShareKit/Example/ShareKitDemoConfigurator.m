...
- (NSArray*)defaultFavoriteTextSharers {
    if([[[NSUserDefaults standardUserDefaults] objectForKey:@"bind"] isEqualToString:@"sina"]){
        return [NSArray arrayWithObjects:@"SHKSinaWeibo",nil];
    }else if([[[NSUserDefaults standardUserDefaults] objectForKey:@"bind"] isEqualToString:@"douban"]){
        return [NSArray arrayWithObjects:@"SHKDouban",nil];
    }else if([[[NSUserDefaults standardUserDefaults] objectForKey:@"bind"] isEqualToString:@"renren"]){
        return [NSArray arrayWithObjects:@"SHKRenRen",nil];
    }
    return [NSArray arrayWithObjects:@"SHKMail",@"SHKDouban",@"SHKSinaWeibo",@"SHKRenren",@"SHKNetEaseWeibo", nil];
}
